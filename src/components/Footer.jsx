  ...
  return (
    <div className="m-auto mt-4 xl:px-14 md:px-12 px-8">
        ...
        <div className="mt-10 mb-10  ">  
          <div className=" rounded-2xl bg-black relative sm:py-32 overflow-hidden dark:overflow-visible dark:my-0 sm:my-16 ">
            <div className=" gap-10 justify-around md:flex "> 
              <h2 className="text-white text-4xl font-semibold sm:text-4xl max-w-xl">STAY UPTO DATE ABOUT OUR LATEST OFFERS</h2>
